        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          <div className="text-center md:text-left">
            ...
            <div className="flex items-center justify-center md:justify-start gap-4">
              <div className="inline-flex items-center gap-3 px-4 py-2.5 rounded-full bg-gradient-to-r from-primary/10 to-accent-purple/10 border border-primary/20">
                {/* Stars */}
              ...
              <span className="text-sm text-muted-foreground">{t.hero.trustLine}</span>
            </div>
          </div>
